...
class Size_Guide {
		...
		wp_localize_script(
			...
			array(
				...
				'settings'      => array(
					...
					'showTools'      => (bool) $settings['show_tools'],
	...
	public static function strings() {
		return array(
			...
			'unitConverter'     => __( 'Unit converter', 'size-guide' ),
			'dpiCalculator'     => __( 'DPI calculator', 'size-guide' ),
			'ratioCalculator'   => __( 'Aspect ratio calculator', 'size-guide' ),
